        ...
        <div class="card card-info">
            <div class="card-header ">
                <h4 class="text-danger text-bold">Add Category
                    <router-link to="/manage-categories" class="btn btn-danger btn-sm float-right">
                        <i class="far fa-hand-point-right"> </i>Manage Category
                    </router-link>
                </h4>
            </div>
            <!-- form start -->
            <form class="form-horizontal" @submit.prevent="addCategory">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" v-model="form.name" class="form-control" id="name" placeholder="Enter Category Name" :class="{ 'is-invalid': form.errors.has('name') }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check form-check-inline">
                                <input v-model="form.status" class="form-check-input" type="radio" id="active" value="1">
            ...
            methods: {
                 addCategory () {
                    ...
                    .then(function(data){
                        /*Toast.fire({
                            icon: 'success',
                            title: 'Category Save in success'
                        }) */
